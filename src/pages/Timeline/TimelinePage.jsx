    ...
    return (
        <div className="min-h-screen bg-background-dark text-slate-100 font-display max-w-7xl mx-auto">
                            ...
                            <div className="text-center">
                                ...
                                <p className="text-sm mt-2 font-extrabold font-mono text-white bg-primary opacity-80 px-2 py-1 rounded-lg flex flex-col items-center w-full">
                                    ...
                                    <span className="text-sm">
                                        {new Date(teamline.foundation_date).toLocaleDateString("en-US", {
                                            month: "short",
                                            day: "2-digit",
                                            year: "numeric"
                                        }).toUpperCase()}
                                ...
                                <div className="flex flex-col gap-3">
                                    ...
                                    <div className="overflow-hidden rounded-2xl bg-slate-900 ring-1 ring-slate-800">
                                        ...
                                        <div className="p-4">
                                            ...
                                            {/* CONTENEDOR DE BOTONES - Ajustado para Responsive */}
                                            <div className="mt-4 flex flex-wrap items-center justify-between gap-3">
                                                ...
                                                {/* BOTONES DE INTERACCIÓN - Flexibles */}
                                            ...
                                            {/* COMMENTS DRAWER - Corregido para no romper el layout */}
                                            {isOpen && (
                                                <div
                                                    className="mt-2 border-t border-slate-800 p-4 flex flex-col gap-3 bg-slate-900/50"
            ...
            {(isAuthenticated && team?.team_id === teamline?.team_id) && (
                <button
                    className="fixed bottom-20 right-8 h-14 w-14 rounded-full bg-primary flex items-center justify-center shadow-lg"
